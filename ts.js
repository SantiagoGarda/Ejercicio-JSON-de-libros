...
var GestorLibros = /** @class */ (function () {
    ...
    GestorLibros.prototype.todo = function (array) {
        console.log('Libros: ', array); /*devuelve por consola todos los libros guardados*/
    };
...
const data = fs.readFileSync("./books.json","utf8") //traemos el JSON
const tranform = JSON.parce(data) //convierte cadenas JSON en objetos JavaScript
Libro.push(data) //pusheamos JSON al objeto LIBRO
